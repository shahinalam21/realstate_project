...
<head>
  ...
  <style>
    .auth-side-wrapper{
      background-image: url("{{asset('uplode/login.png')}}");
      width: 100%;
      height:100%;
    }
  </style>
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('login') }}">
                      ...
                      <div class="mb-3">
                        <label for="login" class="form-label">Email address/phone</label>
                        <input type="text" class="form-control" name="login" id="login" placeholder="Email/Phone">
                      </div>
                      <div class="mb-3">
